...
| `SUPABASE_SERVICE_ROLE_KEY` | Go to https://supabase.com/dashboard/project/_/settings/api-keys > copy the `service_role` secret (starts with `eyJ…`). Used by Grafana Cloud to scrape the Supabase Metrics API. |
